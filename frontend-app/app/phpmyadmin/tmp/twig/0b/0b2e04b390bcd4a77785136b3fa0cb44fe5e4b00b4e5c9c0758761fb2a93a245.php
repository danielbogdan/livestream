...
echo _gettext("Go");
    ...
    {
        return new Source("", "table/insert/get_head_and_foot_of_insert_row_table.twig", "/var/livestream/auth/phpmyadmin/templates/table/insert/get_head_and_foot_of_insert_row_table.twig");
    }
}
